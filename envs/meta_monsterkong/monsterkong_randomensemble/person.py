...
import pygame
import monsterkong_randomensemble.side_collisions
...
class Person(pygame.sprite.Sprite):
    ...
    def checkBottomOnlyCollision(self, colliderGroup): # Return true if bottom of agent is colliding with ladder, but not top of agent
        ...
        for col in colliderGroup:
            ...
            if monsterkong_randomensemble.side_collisions.top(col, self): #Ladder is col, agent is self
    ...
    def checkTopOnlyCollision(self, colliderGroup): # Return true if
        tmp = []
        for col in colliderGroup:
            if monsterkong_randomensemble.side_collisions.bottom(col, self):
                # print("top Only true")
                tmp.append(col)
        # if tmp:
        return tmp
